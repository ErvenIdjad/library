    ...
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <form class="form-horizontal" method="POST" action="return_add.php">
                        ...
                        <div class="col-sm-9">
                            ...
                            <select class="form-control" name="student" id="student" required="">
                                ...
                                <option value="<?php echo $row['student_id'] ?>">
                                    <?php echo ucwords($row['firstname'] . ' ' . $row['lastname']) . ' [' . $row['student_id'] . ']' ?>
                                </option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-sm-9">
                            ...
                            <select class="form-control" name="isbn[]">
                                ...
                                <option value="<?php echo $row['isbn'] ?>">
                                    <?php echo ucwords($row['title']) . ' [' . $row['isbn'] . ']' ?>
                                </option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3">
                            <button class="btn btn-primary btn-xs btn-flat" id="append"><i class="fa fa-plus"></i> Book
                                Field</button>
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary btn-flat pull-left" name="add"><i class="fa fa-save"></i>
                    Save</button>
                </form>
            </div>
        </div>
